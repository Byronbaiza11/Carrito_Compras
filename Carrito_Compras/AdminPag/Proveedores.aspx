<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="Carrito_COmpras.AdminPag.Proveedores" %>
                ...
                <div class="col-md-10 mx-auto">
                    <div class="card shadow-sm">
                        <div class="card-header text-center bg-dark text-light">
                            <h2><i class="fas fa-truck-moving"></i> REGISTRO DE PROVEEDORES</h2>
                        </div>
                        <div class="container">
                            <br />
                            <div class="card-body ">
